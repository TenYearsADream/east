...
// ком_сбросАварии ( Сброс аварии/Лазеры),   Bool, %M526.6   reg = M  width = Bit
    ...
    return "ком_сбросАварии";}

// ком_Блокировки ( Блокировки/Лазеры),   Bool, %M526.7   reg = M  width = Bit
    ...
    return "ком_Блокировки";}

// ком_ТП_пауза ( Пауза/Автоматический процесс),   Bool, %M521.6   reg = M  width = Bit
...
// ком_клНапГаза ( Клапан напуска газа/Рецеркуляция),   Bool, %M521.7   reg = M  width = Bit
    ...
    return "ком_клНапГаза";}

// ком_ТП_стоп ( СТОП/Автоматический процесс),   Bool, %M522.5   reg = M  width = Bit
...
// выхд_ТЭН1_пит ( /Нагреватели),   Bool, %M503.2   reg = M  width = Bit
...
// выхд_стол_отн_вниз ( /Стол),   Bool, %M505.7   reg = M  width = Bit
...
// выхд_стол_отн_вверх ( /Стол),   Bool, %M506.0   reg = M  width = Bit
...
// выхд_лаз_пит1 ( /Лазеры),   Bool, %M506.5   reg = M  width = Bit
...
// выхд_питЧил1 ( /Чиллеры),   Bool, %M506.6   reg = M  width = Bit
...
// выхд_питЧил2 ( /Чиллеры),   Bool, %M506.7   reg = M  width = Bit
...
// выхд_питМПС ( /Каретки),   Bool, %M507.2   reg = M  width = Bit
...
// выхд_питРец ( /Рецеркуляция),   Bool, %M507.3   reg = M  width = Bit
...
// выхд_КВ1 ( /Рецеркуляция),   Bool, %M507.4   reg = M  width = Bit
...
// выхд_КВ2 ( /Рецеркуляция),   Bool, %M507.5   reg = M  width = Bit
...
// выхд_КЭ9 ( /Лазеры),   Bool, %M507.6   reg = M  width = Bit
...
// выхд_КЭ10 ( /Лазеры),   Bool, %M507.7   reg = M  width = Bit
...
// выхд_карПрав_абс ( /Каретки),   Bool, %M508.0   reg = M  width = Bit
...
// выхд_карЛев_абс ( /Каретки),   Bool, %M508.1   reg = M  width = Bit
...
// выхд_дозПрав_впер ( /Дозаторы),   Bool, %M508.2   reg = M  width = Bit
...
// выхд_дозЛев_впер ( /Дозаторы),   Bool, %M508.3   reg = M  width = Bit
...
// выхд_дозПрав_назад ( /Дозаторы),   Bool, %M508.4   reg = M  width = Bit
...
// выхд_дозЛев_назад ( /Дозаторы),   Bool, %M508.5   reg = M  width = Bit
...
// выхд_стол_пересчёт ( /Стол),   Bool, %M280.0   reg = M  width = Bit
...
// выхд_барЛев_вперёд ( /Барабаны),   Bool, %M508.6   reg = M  width = Bit
...
// выхд_барПрав_вперёд ( /Барабаны),   Bool, %M508.7   reg = M  width = Bit
...
// выхд_барЛев_назад ( /Барабаны),   Bool, %M509.0   reg = M  width = Bit
...
// выхд_барПрав_назад ( /Барабаны),   Bool, %M509.1   reg = M  width = Bit
...
// выхд_толкЛев_вперёд ( /Толкатели),   Bool, %M509.2   reg = M  width = Bit
...
// выхд_толкПрав_вперёд ( /Толкатели),   Bool, %M509.3   reg = M  width = Bit
...
// выхд_толкЛев_назад ( /Толкатели),   Bool, %M509.4   reg = M  width = Bit
...
// выхд_толкПрав_назад ( /Толкатели),   Bool, %M509.5   reg = M  width = Bit
...
// выхд_карПрав_отн_вперёд ( /Каретки),   Bool, %M509.6   reg = M  width = Bit
...
// выхд_карПрав_отн_назад ( /Каретки),   Bool, %M509.7   reg = M  width = Bit
...
// выхд_карЛев_отн_вперёд ( /Каретки),   Bool, %M510.0   reg = M  width = Bit
...
// выхд_карЛев_отн_назад ( /Каретки),   Bool, %M510.1   reg = M  width = Bit
...
// выхд_клБарЛев ( /Барабаны),   Bool, %M510.2   reg = M  width = Bit
...
// выхд_клБарПрав ( /Барабаны),   Bool, %M510.3   reg = M  width = Bit
...
// выхд_насОткГаза ( /Барабаны),   Bool, %M510.4   reg = M  width = Bit
...
// выхд_ТП_слой_раб1 ( /Автоматический процесс),   Bool, %M522.0   reg = M  width = Bit
    ...
    return "выхд_ТП_слой_раб1";}

// выхд_ТП_процесс ( /Автоматический процесс),   Bool, %M518.5   reg = M  width = Bit
...
// выхд_лаз_пит2 ( /Лазеры),   Bool, %M510.5   reg = M  width = Bit
...
// выхд_ТП_слой_раб2 ( /Автоматический процесс),   Bool, %M522.1   reg = M  width = Bit
    ...
    return "выхд_ТП_слой_раб2";}

// выхд_ТП_слой_раб3 ( /Автоматический процесс),   Bool, %M522.2   reg = M  width = Bit
    ...
    return "выхд_ТП_слой_раб3";}

// выхд_Блокировки ( /Лазеры),   Bool, %M280.1   reg = M  width = Bit
    ...
    return "выхд_Блокировки";}

// выхд_ТП_пауза ( /Автоматический процесс),   Bool, %M522.3   reg = M  width = Bit
    ...
    return "выхд_ТП_пауза";}

// выхд_клНапГаза ( /Рецеркуляция),   Bool, %M522.4   reg = M  width = Bit
...
//tags/usttp.xml
//-----------------------------------------------------------------------------
// устТП_карПрав_скор ( Каретка правая - скорость/Автоматический процесс),   Real, %MD94   reg = M  width = UInt32
    ...
    return "устТП_карПрав_скор";}

// устТП_карЛев_скор ( Каретка левая -  скорость/Автоматический процесс),   Real, %MD98   reg = M  width = UInt32
    ...
    return "устТП_карЛев_скор";}

// устТП_толкПрав_расст ( Толкатель правый - расст/Автоматический процесс),   Real, %MD106   reg = M  width = UInt32
...
// устТП_карПрав_расст2 ( Каретка правая - расст2/Автоматический процесс),   Real, %MD118   reg = M  width = UInt32
    ...
    return "устТП_карПрав_расст2";}

// устТП_дозПрав_время ( Дозатор правый -  время/Автоматический процесс),   Real, %MD122   reg = M  width = UInt32
    ...
    return "устТП_дозПрав_время";}

// устТП_дозПрав_скор ( Дозатор правый - скорость/Автоматический процесс),   Real, %MD126   reg = M  width = UInt32
    ...
    return "устТП_дозПрав_скор";}

// устТП_карПрав_расст3 ( Каретка правая - расст3/Автоматический процесс),   Real, %MD130   reg = M  width = UInt32
    ...
    return "устТП_карПрав_расст3";}

// устТП_карПрав_расст4 ( Каретка правая - расст4/Автоматический процесс),   Real, %MD134   reg = M  width = UInt32
    ...
    return "устТП_карПрав_расст4";}

// устТП_барПрав_скор ( Бараабан правый - скорость/Автоматический процесс),   Real, %MD138   reg = M  width = UInt32
    ...
    return "устТП_барПрав_скор";}

// устТП_карПрав_расст5 ( Каретка правая - расст5/Автоматический процесс),   Real, %MD142   reg = M  width = UInt32
    ...
    return "устТП_карПрав_расст5";}

// устТП_карЛев_расст1 ( Каретка левая - расст1/Автоматический процесс),   Real, %MD146   reg = M  width = UInt32
    ...
    return "устТП_карЛев_расст1";}

// устТП_толкЛев_расст ( Толкатель левый - расст/Автоматический процесс),   Real, %MD150   reg = M  width = UInt32
...
// устТП_карЛев_расст2 ( Каретка левая - расст2/Автоматический процесс),   Real, %MD162   reg = M  width = UInt32
    ...
    return "устТП_карЛев_расст2";}

// устТП_дозЛев_время ( Дозатор левый -  время/Автоматический процесс),   Real, %MD166   reg = M  width = UInt32
    ...
    return "устТП_дозЛев_время";}

// устТП_дозЛев_скор ( Дозатор левый - скорость/Автоматический процесс),   Real, %MD170   reg = M  width = UInt32
    ...
    return "устТП_дозЛев_скор";}

// устТП_карЛев_расст3 ( Каретка левая - расст3/Автоматический процесс),   Real, %MD174   reg = M  width = UInt32
    ...
    return "устТП_карЛев_расст3";}

// устТП_карЛев_расст4 ( Каретка левая - расст4/Автоматический процесс),   Real, %MD178   reg = M  width = UInt32
    ...
    return "устТП_карЛев_расст4";}

// устТП_барЛев_скор ( Бараабан левый - скорость/Автоматический процесс),   Real, %MD182   reg = M  width = UInt32
    ...
    return "устТП_барЛев_скор";}

// устТП_карЛев_расст5 ( Каретка левая - расст5/Автоматический процесс),   Real, %MD186   reg = M  width = UInt32
    ...
    return "устТП_карЛев_расст5";}

// устТП_толщСлоя2 ( Толщина слоя2/Автоматический процесс),   Real, %MD190   reg = M  width = UInt32
    ...
    return "устТП_толщСлоя2";}

// устТП_пауза1 ( Пауза1/Автоматический процесс),   Real, %MD194   reg = M  width = UInt32
...
// устТП_толщСлоя1 ( Толщина слоя1/Автоматический процесс),   Real, %MD202   reg = M  width = UInt32
    ...
    return "устТП_толщСлоя1";}

// устТП_пауза2 ( Пауза2/Автоматический процесс),   Real, %MD198   reg = M  width = UInt32
...
// устТП_карПрав_расст1 ( Каретка правая - расст1/Автоматический процесс),   Real, %MD102   reg = M  width = UInt32
...
// АМ_лаз1_темп1 ( Температура1/Чиллеры),   Real, %MD654   reg = M  width = UInt32
    ...
    return "АМ_лаз1_темп1";}

// АМ_лаз1_темп2 ( Температура2/Чиллеры),   Real, %MD658   reg = M  width = UInt32
    ...
    return "АМ_лаз1_темп2";}

// АМ_лаз1_темп3 ( Температура3/Чиллеры),   Real, %MD662   reg = M  width = UInt32
    ...
    return "АМ_лаз1_темп3";}

// АМ_лаз2_темп1 ( Температура4/Чиллеры),   Real, %MD666   reg = M  width = UInt32
    ...
    return "АМ_лаз2_темп1";}

// АМ_лаз2_темп2 ( Температура5/Чиллеры),   Real, %MD670   reg = M  width = UInt32
    ...
    return "АМ_лаз2_темп2";}

// АМ_лаз2_темп3 ( Температура6/Чиллеры),   Real, %MD674   reg = M  width = UInt32
...
// номер (номер/UDEFINED),   Int, %MW684   reg = M  width = UInt16
...
// АМ_давл в камере дублёр ( Давление в камере дублёр/Рецеркуляция),   Real, %MD686   reg = M  width = UInt32
    ...
    return "АМ_давл в камере дублёр";}

// АМ_оксик ( Датчик кислорода/Рецеркуляция),   Real, %MD690   reg = M  width = UInt32
...
// порошок (порошок/UDEFINED),   Int, %MW694   reg = M  width = UInt16
    public Int16 get_poroshok ()
    { return (Int16) m_mem.getMUInt16(694); }

    public void set_poroshok (Int16 val)
    { m_mem.setMUInt16(694, (UInt16) val); 
      Log.Write(LogLevel.Info, "set poroshok to " + val.ToString());}

    public bool sets_poroshok ( string str) {
    Int16 val;
    if (!Int16.TryParse(str, out val)){
        System.Windows.MessageBox.Show("Failed on try parse " + str + " as Int16 ");
        return false; }
    ...
    public string gets_poroshok () { 
    return get_poroshok().ToString();}

    public string debug_name_poroshok () { 
    return "порошок";}
...
"разрешение",
"готовность",
" Сканатор1 - охлаждение",
" Сканатор2 - охлаждение",
" Лазер1 - охлаждение",
" Лазер2 - охлаждение",
...
" Дозатор правый -  время",
" Дозатор правый - скорость",
" Каретка правая - расст3",
" Каретка правая - расст4",
" Бараабан правый - скорость",
" Каретка правая - расст5",
...
" Дозатор левый -  время",
" Дозатор левый - скорость",
" Каретка левая - расст3",
" Каретка левая - расст4",
" Бараабан левый - скорость",
" Каретка левая - расст5",
" Толщина слоя2",
" Пауза1",
" Толщина слоя1",
" Пауза2",
...
sGetters[(int)gTags.poroshok] =  gets_poroshok;
}
...
sSetters[(int)gTags.poroshok] =  sets_poroshok;
}
