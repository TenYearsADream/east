...
// выхд_дозПрав_назад (выхд_дозПрав_назад/UDEFINED),   Bool, %M508.4   reg = M  width = Bit
...
// выхд_дозЛев_назад (выхд_дозЛев_назад/UDEFINED),   Bool, %M508.5   reg = M  width = Bit
...
// выхд_барЛев_вперёд (выхд_барЛев_вперёд/UDEFINED),   Bool, %M508.6   reg = M  width = Bit
...
// выхд_барЛев_назад (выхд_барЛев_назад/UDEFINED),   Bool, %M509.0   reg = M  width = Bit
...
// выхд_толкПрав_вперёд (выхд_толкПрав_вперёд/UDEFINED),   Bool, %M509.3   reg = M  width = Bit
...
// выхд_толкЛев_назад (выхд_толкЛев_назад/UDEFINED),   Bool, %M509.4   reg = M  width = Bit
...
// выхд_карПрав_отн_назад (выхд_карПрав_отн_назад/UDEFINED),   Bool, %M509.7   reg = M  width = Bit
...
// выхд_карЛев_отн_вперёд (выхд_карЛев_отн_вперёд/UDEFINED),   Bool, %M510.0   reg = M  width = Bit
...
// выхд_карЛев_отн_назад (выхд_карЛев_отн_назад/UDEFINED),   Bool, %M510.1   reg = M  width = Bit
...
// выхд_клБарЛев (выхд_клБарЛев/UDEFINED),   Bool, %M510.2   reg = M  width = Bit
...
// выхд_ТП_слой_раб2 (выхд_ТП_слой_раб2/UDEFINED),   Bool, %M522.1   reg = M  width = Bit
...
// выхд_ТП_слой_раб3 (выхд_ТП_слой_раб3/UDEFINED),   Bool, %M522.2   reg = M  width = Bit
...
// выхд_Блокировки (выхд_Блокировки/UDEFINED),   Bool, %M280.1   reg = M  width = Bit
...
" ",
" ",
"выхд_толкПрав_вперёд",
"выхд_толкЛев_назад",
" ",
" ",
"выхд_карПрав_отн_назад",
"выхд_карЛев_отн_вперёд",
"выхд_карЛев_отн_назад",
"выхд_клБарЛев",
" ",
" ",
" ",
